                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-2">
                                        <div class="img-thumbnail mt-n5"><img src="@if($user->image){{ $user->image->url }} @else https://via.placeholder.com/140x140.png?text=140x140 @endif" alt="{{ $user->name }}" height="140" width="140" class=""></div>
                                        </div>
                                        <div class="col-sm-10">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card card-accent-primary">
                                ...
                                <div class="card-body">
                                    You don't add any shop yet!
                                    <p>
                                        <button class="btn btn-light active mt-3" type="button">Add Now!</button>
                                    </p>
                                </div>
                            </div>
                        </div>
